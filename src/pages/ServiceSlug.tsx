...
import { ArrowRight, CheckCircle2, ChevronRight, Sparkles, Layers3 } from "lucide-react"
...
export default function ServiceSlug({ locale, t }: Props) {
  ...
  const lp = useCallback(
    (path: string) => buildPathWithLocale(locale, path),
    [locale]
  )
  ...
  }, [isFound, serviceKeyBase, locale, siteUrl, servicesHubPath, canonicalServicePath, resolved.rawSlug, resolved.canonicalSlug, t])
  ...
  const headerServicesDropdown = useMemo(
    () => [
      { href: "/services/full-stack", labelKey: "services.page.list.items.fullStackDev.label" },
      { href: "/services/performance", labelKey: "services.page.list.items.performanceOptimization.label" },
      { href: "/services/ux-ui", labelKey: "services.page.list.items.uxui.label" },
      { href: "/services/seo", labelKey: "services.page.list.items.seo.label" },
      { href: "/services/geo-llm", labelKey: "services.page.list.items.geo.label" },
      { href: "/services/aeo", labelKey: "services.page.list.items.aeo.label" },
      { href: "/services/content", labelKey: "services.page.list.items.contentWriting.label" },
      { href: "/services/ecommerce", labelKey: "services.page.list.items.ecommerce.label" },
      { href: "/services/ai-automation", labelKey: "services.page.list.items.aiAutomation.label" },
    ],
    []
  )
  ...
  if (!isFound) {
    return (
      <>
      <Header t={t} locale={locale} brand={headerBrand} />
  ...
  return (
    <>
      <Header t={t} locale={locale} brand={headerBrand} servicesDropdown={headerServicesDropdown} />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-10 items-start">
                ...
                <div className="rounded-[28px] border border-border/60 bg-background/55 backdrop-blur-2xl p-6 shadow-sm">
                  ...
                  <a
                    ...
                    className="mt-5 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition"

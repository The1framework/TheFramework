...
export default function Services(_: ServicesPageProps) {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20">
        ...
        <section
          ref={audiencesRef}
          id="services-for-who"
          aria-labelledby="services-for-who-heading"
              ...
              >
                {faqItems.map((item, idx) => (
                  ...
                  >
                    <summary
                      className={cn(
                        "flex items-center justify-between gap-4 cursor-pointer list-none",
                        isRTL && "text-right"
                      )}
                    >
                    ...
                    <div className={cn("mt-3 text-sm md:text-base text-muted-foreground/95", isRTL && "text-right")}>
                      {item.a}
                    </div>
                  </details>
                ))}
